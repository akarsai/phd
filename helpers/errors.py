...
def calculate_projection_method_errors(
        ...
        # manufactured_solution: callable = None, # only needed for L2 error in z3 variable
    ...
    for k, nt in enumerate(nt_array):
        ...
        if nodal_superconvergence: # analyze superconvergence
            ...
            # error_3 = rhs[:,d1+d2:]  # nodal superconvergence does not work for algebraic variables
...
def energy_balance_error(
    ...
    def body(k, tup):
        ...
        # NOTE: z3 uses the lower degree array 'phi_at_nqn_gauss_points' and 'nd' indices
